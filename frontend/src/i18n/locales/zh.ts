export default {
  ...
  aiChat: {
    title: 'AI 对话',
    description: '选择分组和 API 密钥，直接通过网关体验对话模型',
    selectedGroup: '当前分组',
    selectedKey: '当前密钥',
    notSelected: '未选择',
    model: '模型',
    ...
    apiKey: 'API 密钥',
    selectGroup: '选择分组',
    selectApiKey: '选择该分组下的 API 密钥',
    refreshCredentials: '刷新分组与密钥',
    usageInfo: '本次用量',
    promptTokens: '输入 Token',
    completionTokens: '输出 Token',
    totalTokens: '总 Token',
    chatWindow: '对话窗口',
    chatHint: '请求会使用你选择的 API 密钥，并进入现有用量统计',
    clear: '清空对话',
    emptyTitle: '开始一次 AI 对话',
    emptyDescription: '选择分组和 API 密钥后，在下方输入问题即可发送。',
    noGroups: '暂无可用分组，请先确认账户权限或订阅。',
    noKeysInGroup: '当前分组下没有活跃 API 密钥，请先创建或切换分组。',
    credentialsFailed: '加载分组或 API 密钥失败',
    inputPlaceholder: '例如：帮我分析今天渠道消耗，并给出三条优化建议',
  ...
  aiImages: {
    title: 'AI 生图',
    description: '选择 OpenAI 分组和 API 密钥，通过网关生成图片',
    selectedGroup: '当前分组',
    selectedKey: '当前密钥',
    notSelected: '未选择',
    model: '模型',
    ...
    count: '数量',
    prompt: '提示词',
    promptPlaceholder: '例如：为潮玩盲盒生成一张小红书封面，柔和灯光，电商海报风格',
    stop: '停止',
    generate: '生成图片',
    generating: '生成中...',
    tipsTitle: '使用提示',
    tipOpenAI: '图片接口当前仅支持 OpenAI 平台分组。',
    tipBilling: '生成请求会按现有图片计费和用量日志记录。',
    tipPrompt: '提示词越具体，生成结果越稳定。',
    results: '生成结果',
    resultsHint: '支持展示 URL 或 base64 图片结果',
    clear: '清空结果',
    emptyTitle: '还没有生成图片',
    emptyDescription: '填写提示词并选择分组下的 API 密钥后开始生成。',
    noOpenAIGroups: '暂无可用 OpenAI 分组，图片生成需要 OpenAI 平台分组。',
    noKeysInGroup: '当前分组下没有活跃 API 密钥，请先创建或切换分组。',
    credentialsFailed: '加载 OpenAI 分组或 API 密钥失败',
    copy: '复制',
    download: '下载',
    copied: '图片地址已复制',
    copyFailed: '复制图片地址失败',
    emptyResponse: '生成完成，但响应中没有可展示的图片。',
    requestFailed: '图片生成失败'
  },

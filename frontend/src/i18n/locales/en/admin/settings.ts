    ...
    settings: {
      ...
      features: {
        excelBpsImages: {
          ...
          invalidLimits: 'Use whole numbers within the displayed ranges. The per-request size must cover one image; storage size and count must cover one request.',
          maxImageMiB: 'Per-image limit (MiB)',
          maxImages: 'Images per request',
          maxTotalMiB: 'Total image size per request (MiB)',
          storageMiB: 'Temporary storage per process (MiB)',

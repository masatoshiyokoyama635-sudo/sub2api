export default {
    accounts: {
      turnStateHunter: {
        candidatesTitle: "Background hunter candidates",
        sharedCache: "Hunter candidates use shared storage and remain accessible after a service restart or from another instance until expiry.",
        localCache: "Hunter candidates currently use process-local storage and are cleared on restart.",
        recoveryUsageKey: "Usage API key ID (blank: hunter setting)",
        configure: "Configure hunter",
        shortcutHint: "Runs in the background and supports rotating proxies from IP management.",
        attemptResponseModel: "Upstream response model",
        authBlocked: "Credential authentication failed. Probing is paused until credentials are updated.",
        rateLimitUntil: "Rate limited until",
        "title": "Background hunter scheduler",
        "description": "Once saved and enabled, the scheduler replenishes candidates across models and proxies without waiting for a user request.",
        "needsReuse": "The background hunter requires v2 capture and HTTP reuse. Recovery probes also support observation mode.",
        "models": "Models to probe",
        "modelsPlaceholder": "One upstream model per line, up to 8",
        "autoModels": "Choose models from recent real requests. Overrides the manual list; real traffic is needed after a restart.",
        "proxies": "Probe proxies",
        "proxiesHint": "Select one or more proxies from IP management. Normal requests continue to use the account’s assigned proxy.",
        "noProxies": "Add a proxy in IP management, then reopen the account dialog.",
        "unavailableProxy": "Unavailable or unloaded proxy",
        "rotationHint": "Check proxies that change exit IP on every new connection. Probes open new connections; rotation depends on your proxy provider. Unchecked proxies use fixed-exit scheduling.",
        "autoRotation": "Rotation detected",
        "hourlyLimit": "Maximum probes per hour",
        "gap": "Probe interval (seconds)",
        "lead": "Start before expiry (minutes)",
        "idle": "Waiting for real traffic",
        "retry": "Retry after an unsuccessful round (minutes)",
        "usageKey": "Usage API key ID (blank: no record)",
        "effort": "Probe reasoning effort",
        "defaultEffort": "Default (high)",
        "hold": "Pause model scheduling when a reusable candidate is missing",
        "holdHint": "Only the hunted model on this account is paused. Requests try another account, or return 503 if none is available. Scheduling resumes when a candidate is collected.",
        "lengthsHint": "Uses the candidate lengths above; length is not a measure of model quality. Current lengths:",
        "recoveryTitle": "Account exit recovery probes",
        "recoveryHint": "Runs independently of the hunter using the account’s original proxy. A matching streak records recovery and stops; repeated failures trigger cooldown. It does not change the account proxy or settings.",
        "recoveryModel": "Recovery probe model",
        "recoveryModelAuto": "Blank: most recent model with real traffic",
        "streakTarget": "Required matching streak",
        "cooldown": "Cooldown after repeated failures (hours)",
        "minInterval": "Minimum probe interval (minutes)",
        "maxInterval": "Maximum probe interval (minutes)",
        "lengthsRequired": "Select at least one valid candidate length before enabling hunter or recovery probes.",
        "selectionRequired": "Enable automatic models or enter model names, and select at least one probe proxy.",
        "selectionLimit": "Select at most 8 models and 64 probe proxies.",
        "invalidNumber": "Enter an integer within the displayed range, or leave blank for the default.",
        "invalidInterval": "The maximum recovery interval must be at least the minimum.",
        "invalidEffort": "Select a supported reasoning effort.",
        "runtimeTitle": "Background hunter status",
        "recoveryStatusTitle": "Account exit recovery status",
        "enabled": "Enabled",
        "disabled": "Disabled",
        "noRuntime": "Settings saved; no background probe results yet.",
        "nextAt": "Next run",
        "hourCount": "Probes this hour",
        "gate": "Scheduler status",
        "updatedAt": "Last state update",
        "running": "Waiting for next probe round",
        "fresh": "Candidate is still fresh",
        "capWait": "Hourly limit reached",
        "runtimeError": "The latest probe did not succeed. Check proxy availability and service logs.",
        "attemptTime": "Time",
        "attemptModel": "Model",
        "attemptProxy": "Proxy ID",
        "attemptStatus": "HTTP status",
        "attemptLength": "State length",
        "attemptResult": "Candidate check",
        "accepted": "Matches candidate rules",
        "notAccepted": "Does not match candidate rules",
        "attemptLatency": "Latency (ms)",
        "streak": "Matching streak",
        "failStreak": "Failure streak",
        "recoveredAt": "Recovery marked at",
        "coolingUntil": "Cooling until",
        "attemptsHint": "Actual probe results only. Matching candidate rules does not guarantee the upstream model.",
        "unknownGate": "Waiting for scheduling",
        "exitCount": "Recorded fixed exits",
        "idleMinutes": "Pause after no real traffic (minutes, -1 disables)"
      },
      codexTurnStateStatus: {
        effectiveCollection: "Effective collection method",
        collectionTitle: "Active collection results",
        collectionActualOnly: "Records collection requests actually started for this model. Requests skipped because of cooldown or concurrency limits are not counted.",
        collectionAttempts: "Collection attempts for this model",
        collectionResult: "Last collection result",
        collectionStarted: "Last collection started",
        collectionFinished: "Last collection finished",
        collectionNextEligible: "Earliest next attempt for credential account",
        collectionHTTPStatus: "Collection HTTP status",
        collectionStateLength: "State length returned by collection",
        collectionReasons: {
          in_progress: "Collecting",
          accepted: "Usable candidate obtained",
          missing_state: "No state returned",
          length_not_allowed: "Returned length excluded by configuration",
          invalid_format: "Returned state does not meet candidate format criteria",
          future_timestamp: "Returned state timestamp is in the future",
          expired: "Returned state exceeds the local retention limit",
          stale: "Returned state is older than the existing candidate",
          model_mismatch: "Declared response model differs from the collection model",
          model_unobserved: "Response model not observed",
          incomplete_response: "Response did not complete",
          response_failed: "Upstream returned a failed response",
          body_too_large: "Response exceeds the collection read limit",
          transport_error: "Collection connection failed",
          timeout: "Collection timed out",
          unauthorized: "Upstream authentication rejected (401)",
          forbidden: "Upstream access forbidden (403)",
          rate_limited: "Upstream rate limited (429)",
          upstream_error: "Upstream request failed",
          configuration_changed: "Configuration changed during collection; result discarded",
          collection_failed: "Collection failed",
          unknown: "Unrecognized collection result",
        },
        effectiveMode: "Effective mode",
        effectiveIdentity: "Effective identity version",
        effectiveLengths: "Effective candidate lengths",
        noSelectedLengths: "None selected (length observations only)",
        attemptsOnly: "Reuse counts record candidate selection attempts. They do not prove upstream acceptance or guarantee the requested model.",
        totalReuseAttempts: "Total reuse attempts for this model",
        unavailable: "Unavailable",
        lastSelection: "Last selection / skip",
        lastRejection: "Last candidate rejection",
        lastInvalidation: "Last candidate invalidation",
        lastRequest: "Last completed request comparison",
        lastRequestOnly: "Only the last completed request for this model is retained; this is not a full request history.",
        requestTime: "Completed at",
        requestId: "Request ID",
        requestOutcome: "Request outcome",
        requestFailed: "Failed",
        requestCompleted: "Completed",
        outboundState: "Outbound state length / source",
        outboundModel: "Outbound model",
        sourceNone: "No state",
        sourceClient: "Client state",
        sourceCandidate: "Cached candidate",
        selection: "Candidate selection result",
        responseModel: "Model declared by upstream",
        responseModelUnknown: "Response model not observed",
        modelComparison: "Compared with outbound model",
        modelMismatch: "Declared and outbound model names differ",
        modelMatches: "Declared and outbound model names match",
        observationHistory: "Observed length history",
        noObservations: "No returned state has been observed yet.",
        currentCandidate: "Current cached candidate",
        reuseNotEnabled: "A candidate is cached; the effective server configuration has reuse disabled.",
        candidateLengthExcluded: "This candidate length is excluded by the current configuration and will not be reused.",
        candidateReuseAttempts: "Reuse attempts for this candidate",
        reasons: {
          collection_cooldown: "Collection was rejected for this credential; generation was not sent during cooldown",
          collection_rejected: "Upstream rejected this collection attempt; generation was not sent",
          collection_pending: "Collection for this credential is still unresolved; generation was not sent",
          reused: "Cached candidate selected",
          no_candidate: "No usable candidate",
          expired: "Local retention limit exceeded",
          length_not_allowed: "Length excluded by current configuration",
          observe_mode: "Observe mode; no candidate selected",
          client_state: "Client supplied a state; candidate selection skipped",
          client_continuation: "Client continuation; candidate selection skipped",
          client_metadata_state: "Client metadata supplied a state; candidate selection skipped",
          accepted: "New candidate accepted",
          refreshed: "Candidate updated",
          unchanged: "Candidate unchanged",
          invalid_format: "State format does not meet candidate criteria",
          future_timestamp: "State timestamp is in the future",
          stale: "Older than the existing candidate",
          state_echo: "State returned after reuse; candidate lifetime is unchanged",
          upstream_rejected: "Upstream request rejected; candidate invalidated",
          unknown: "Unrecognized reason",
        },
        title: "Turn-state observations",
        refresh: "Refresh observations",
        clear: "Clear current cache",
        loading: "Loading…",
        empty: "No normal request observations yet. States returned by normal requests appear here; background hunter candidates and probe records are shown separately.",
        localOnly: "Passive candidates and observation statistics belong to the current server process and are cleared on restart. Hunter candidate storage is shown separately. Refreshing does not call the upstream.",
        loadFailed: "Could not load observations. Try again.",
        clearFailed: "Could not clear candidates. Try again.",
        observed: "Observed {count} times",
        lastObserved: "Last observed",
        length: "Length",
        digest: "Digest",
        issued: "State timestamp",
        expires: "Local expiry",
        reused: "Reuse attempts: {count}",
        lastReused: "Last reuse attempt",
        noCandidate: "No reusable candidate",
        otherLengths: "Other lengths: {count}",
        notReused: "Not reused yet",
        savedSettings: "This panel shows the server configuration and observations from the last refresh. Save edits above before they take effect.",
      },
      ...
      openai: {
        ...
        codexTurnStateCollection: "Collection method",
        codexTurnStateCollectionPassive: "Collect from normal traffic (default)",
        codexTurnStateCollectionActive: "Collect actively when no candidate exists",
        codexTurnStateCollectionDesc: "Available only in reuse mode. Sends an extra short collection request when no candidate exists and the normal request has no client state or continuation. No background collection occurs without traffic.",
        codexTurnStateCollectionLimits: "Waits at least 180 seconds after each collection finishes for the same credential account. Each attempt has a 20-second limit, with at most 2 concurrent attempts per process. Uses the current account and proxy; neither a 332 state nor an Astra response is guaranteed.",
        codexTurnStateMode: "Turn state (v2)",
        codexTurnStateModeDesc: "By default, capture states returned by normal requests. Reuse applies only to HTTP requests without a state, isolated by credential and model. Active collection requires a separate opt-in.",
        codexTurnStateOff: "Off (default)",
        codexTurnStateObserve: "Observe and capture",
        codexTurnStateReuse: "Capture and try HTTP reuse",
        codexTurnStateLengths: "Reusable candidate lengths",
        codexTurnStateLengthsDesc: "Defaults to 292 and 332; adjust using your Team observations. Length selects candidates and does not indicate model quality. Enter up to 8 comma-separated integers from 100 to 2048. Leave empty to observe without selecting candidates.",
        codexTurnStateLengthsInvalid: "Enter up to 8 distinct comma-separated integers from 100 to 2048, or leave empty.",
        codexTurnStateBulkDesc: "Available for v2 credential accounts. You can select v2 in the same update. Exclude shadows and agentIdentity accounts from this bulk change. Leave unchecked to preserve settings.",
        codexTurnStateRequiresV2: "Observation and reuse require Codex identity v2. Select v2 or leave the identity version unchanged.",

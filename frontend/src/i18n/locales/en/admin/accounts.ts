export default {
    accounts: {
      ...
      pelicanTest: {
        runForHours: 'Run duration (hours, 1–168)',
        stopsAt: 'Stops at',

        schedule: 'Scheduled tests',
        scheduleHint: 'Runs on the server even after closing this page. Pausing prevents new runs; tests already started will finish.',
        ...
        resume: 'Resume',
        nextRun: 'Next run',
        lastSuccess: 'Last success (retained history)',
        intervalMinutes: 'Interval (minutes)',
        createSchedule: 'Create schedule',
        scheduleSaveHint: 'Saves the prompt, model, reasoning and parallel count above. Interval: 1–10080 minutes. Keeps up to 50 outputs for 7 days; cleanup continues while paused. Stops after 24 hours by default. The interval must be shorter than the duration. Saving or resuming resets the stop time. Runs after one interval when saved or resumed, with about one minute of scheduling delay. Missed runs are not replayed.',
        scheduledHistory: 'Scheduled test history',

export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnStateModeDesc: "Capture states returned by normal requests without extra upstream calls. Reuse applies only to HTTP requests without a state, isolated by credential and model; client states are never overwritten.",

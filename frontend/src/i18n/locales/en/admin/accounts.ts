export default {
    accounts: {
      codexTurnStateStatus: {
        ...
        loading: "Loading…",
        empty: "No observations yet. Enable capture and save the account; states returned by normal requests will appear here.",
        localOnly: "Current server process and identity configuration only; cleared on restart. Refreshing does not call the upstream.",

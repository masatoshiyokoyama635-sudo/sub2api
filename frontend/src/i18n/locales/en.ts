export default {
  ...
  aiChat: {
    title: 'AI Chat',
    description: 'Choose a group and API key to try chat models through the gateway',
    ...
    selectApiKey: 'Select an API key in this group',
    refreshCredentials: 'Refresh groups and keys',
    usageInfo: 'Usage',
    promptTokens: 'Prompt Tokens',
    completionTokens: 'Completion Tokens',
    totalTokens: 'Total Tokens',
    chatWindow: 'Chat Window',
    chatHint: 'Requests use your selected API key and are recorded by existing usage logs',
    clear: 'Clear Chat',
    emptyTitle: 'Start an AI chat',
    emptyDescription: 'Select a group and API key, then type your question below.',
    noGroups: 'No available groups. Check your account permissions or subscriptions first.',
    noKeysInGroup: 'This group has no active API keys. Create one or switch groups.',
    credentialsFailed: 'Failed to load groups or API keys',
    inputPlaceholder: 'Example: Analyze today\'s channel spend and give three optimization tips',
    ...
    emptyResponse: 'The model did not return text content.',
    requestFailed: 'Chat request failed'
  },

  aiImages: {
    title: 'AI Images',
    description: 'Choose an OpenAI group and API key to generate images through the gateway',
    selectedGroup: 'Selected Group',
    selectedKey: 'Selected Key',
    notSelected: 'Not selected',
    model: 'Model',
    ...
    group: 'OpenAI Group',
    apiKey: 'API Key',
    selectGroup: 'Select OpenAI group',
    selectApiKey: 'Select an API key in this group',
    size: 'Size',
    count: 'Count',
    prompt: 'Prompt',
    promptPlaceholder: 'Example: Create a Xiaohongshu cover for a blind box toy, soft lighting, ecommerce poster style',
    stop: 'Stop',
    generate: 'Generate Images',
    generating: 'Generating...',
    tipsTitle: 'Tips',
    tipOpenAI: 'Image generation currently supports OpenAI platform groups only.',
    tipBilling: 'Generation requests use existing image billing and usage logs.',
    tipPrompt: 'More specific prompts usually produce more stable results.',
    results: 'Results',
    resultsHint: 'URL and base64 image responses are both supported',
    clear: 'Clear Results',
    emptyTitle: 'No images yet',
    emptyDescription: 'Enter a prompt and select an API key under a group to generate images.',
    noOpenAIGroups: 'No available OpenAI groups. Image generation requires an OpenAI platform group.',
    noKeysInGroup: 'This group has no active API keys. Create one or switch groups.',
    credentialsFailed: 'Failed to load OpenAI groups or API keys',
    copy: 'Copy',
    download: 'Download',
    copied: 'Image source copied',
    copyFailed: 'Failed to copy image source',
    emptyResponse: 'Generation completed, but no displayable image was returned.',
